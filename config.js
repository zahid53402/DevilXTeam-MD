...
const baseConfig = {
  ...
  BOT_INFO: "DevilXteam MD;" + ((process.env.BOT_INFO || "").split(";")[1] || "DevilXteam") + ";default",
  RBG_KEY: process.env.RBG_KEY || "",
  ALLOWED: process.env.ALLOWED || "91,94,2",
  NOT_ALLOWED: process.env.NOT_ALLOWED || "852",
  CHATBOT: process.env.CHATBOT || "off",
  HANDLERS: process.env.HANDLERS || ".,",
  STICKER_DATA: process.env.STICKER_DATA || "DevilXteam MD;DevilXteam;😈",
  ...
  SUPPORT_GROUP: process.env.SUPPORT_GROUP || "https://t.me/devilxteam",
  CHANNEL_LINK: "https://whatsapp.com/channel/0029Vb79zv13mFY8wJw14h1T",
  MENU_SONG_URL: process.env.MENU_SONG_URL || "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
  CHANNEL_INVITE: "0029Vb79zv13mFY8wJw14h1T",
