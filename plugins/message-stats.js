...
function timeSince(date) {
  ...
  if (interval > 1) {
    return Math.floor(interval) + " saal pehle";
  }
  interval = seconds / 2592000;
  if (interval > 1) {
    return Math.floor(interval) + " maheene pehle";
  }
  interval = seconds / 86400;
  if (interval > 1) {
    return Math.floor(interval) + " din pehle";
  }
  interval = seconds / 3600;
  if (interval > 1) {
    return Math.floor(interval) + " ghante pehle";
  }
  interval = seconds / 60;
  if (interval > 1) {
    return Math.floor(interval) + " minute pehle";
  }
  return Math.floor(seconds) + " second pehle";
}
